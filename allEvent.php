...
$sql = "SELECT * FROM events
        ORDER BY MONTH (eventDate), DAY(eventDate) ";
$stmt = $pdo->query($sql);
?>
			...
			<div class="imgGrid">
				...
				while($row =$stmt->fetchObject()){
                        echo '<div class="grid">';
                            ...
                            echo "<img src=\"images/{$row->eventImage}\">";


                            //MORE DETAILS BUTTON THAT PASSES THE ID
                            echo "<div class=\"preview\"><a href=\"#\" data-id=\"{$row->eventId}\"class=\"getPreview\">Preview</a>
                                  <a href=\"moreinfo.php?eventId={$row->eventId}\">More Details</a></div>";
